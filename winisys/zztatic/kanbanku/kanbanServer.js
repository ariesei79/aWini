...
app.use("/qdb", qdbRouter);//Tambahan barakids
...
app.use('/files', express.static('E:/database')); // sesuaikan direktori file asli
app.use('/files', express.static('E:/indicationslip')); // sesuaikan direktori file asli
app.use('/files', express.static('E:/ids')); // sesuaikan direktori file asli
app.use('/files', express.static('E:/krd')); // sesuaikan direktori file asli
...
app.use("/api/kanbanku", kanbankuRouter);
//app.use("/PE_stuff", dirnoRouter)
// Menjalankan server
app.listen(port, () => {
