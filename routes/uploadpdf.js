...
const uploadDirQC = path.join(__dirname, '../winisys/zztatic/QC/Public');
...
router.post('/uploadQC', upload.single('pdfFile'), (req, res) => {
    ...
    const filePath = path.join(uploadDirQC, customFileName2);
